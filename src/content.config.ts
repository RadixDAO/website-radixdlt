...
const blog = defineCollection({
  loader: glob({ pattern: '**/*.json', base: './src/content/blog', generateId: ({ data }) => data.id }),
  schema: z.object({
    id: z.string(),
    cmsLocaleId: z.string(),
    lastPublished: z.string().nullable(),
    ...
    fieldData: z.object({
      ...
      "show-table-of-contents": z.boolean(), // Switch
      "blog-author": z.string().nullable(), // Reference
      "featured-post": z.boolean(), // Switch
      "blog-category": z.array(z.string()).nullable(), // MultiReference
      ...
      "seo-meta-description": z.string().nullable(), // PlainText
      "use-video-over-image": z.boolean(), // Switch
      "video-code": z.string().nullable(), // PlainText
      "video-mp4-url": z.string().nullable(), // PlainText
      "video-webm-url": z.string().nullable(), // PlainText
      "name": z.string(), // PlainText
      "slug": z.string(), // PlainText
    }),
  }),
